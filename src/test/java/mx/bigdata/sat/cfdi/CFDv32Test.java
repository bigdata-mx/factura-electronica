...
public final class CFDv32Test {
  ...
  @Test public void testSign() throws Exception {
    CFDv32 cfd = new CFDv32(ExampleCFDv32Factory.createComprobante(), 
                          "mx.bigdata.sat.cfdi.examples");
    cfd.sellar(key, cert);
    String signature = "AMLMtSJp9zwUNRlYybXquVFS8TMIhHhPv3BhpkMHXL/cuYMlIPO41c4Ac5EOMzALNzUOcuvybuBdzSuWgUIo4EAvJql9CNJyKjl5ktS0bsimFYSquMYDxRNucp2hCBQEVEfKGbgZctaUNpkOlzzxd8B55RNWlL/f96pQWIVtCOc=";
