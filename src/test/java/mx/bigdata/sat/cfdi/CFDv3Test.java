...
public final class CFDv3Test {
  ...
  @Test public void testOriginalString() throws Exception {
    ...
    assertEquals(cadena, cfd.getOriginalString());
  }
    
  @Test public void testSign() throws Exception {
    CFDv3 cfd = new CFDv3(ExampleCFDFactory.createComprobante());
    cfd.sign(key, cert);
    String signature = "uo+1Boc1MWbT4so1/Rp1lG1xjVLJBMAMmV2Bkh4psNCRvGLQqi/22cD45XqTV9MWwmCU8nBSE7PJJp0xMSi0JML7HAXZollIBUAdzzSFhSP64+EGokW0bc+a8JVbNnkRFaxtTiScw+vOjDUzoA4ZUdV8qk9hBj3sLTPNosKxEpk=";
